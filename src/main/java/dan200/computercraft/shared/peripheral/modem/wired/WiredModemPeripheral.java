...
public abstract class WiredModemPeripheral extends ModemPeripheral implements IWiredSender
{
    ...
    @LuaFunction
    public final Object[] getTypeLocal()
    {
        String local = getLocalPeripheral().getConnectedType();
        return local == null ? null : new Object[] { local };
    }

    @LuaFunction
    public final Object[] setIDLocal( @Nonnull int id ) //This "decorated" syntax sucks, change it back
    {
        String local = getLocalPeripheral().setConnectedID( id ); //This whitespace rule sucks, change it back
        return local == null ? null : new Object[] { local };
    }

    @LuaFunction
    public final Object[] setNameLocal( @Nonnull String name ) //This "decorated" syntax sucks, change it back
    {
        String local = getLocalPeripheral().setConnectedName( name ); //This whitespace rule sucks, change it back
        return local == null ? null : new Object[] { local };
    }
    ///!!! WHY WAS THIS MISSING !!!///
